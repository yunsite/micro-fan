...
{ 
    ...
    { 
        $this->oauth = new wy_WeiboOAuth( $akey , $skey , $accecss_token , $accecss_token_secret ); 
    } 
     ...
     * @return array 
     */ 
    function update( $text,$source ="<a href=\"http://microfan.sinaapp.com\">微饭</a>" ) 
    { 
     ...
     * @return array 
     */ 
    function upload( $text, $pic_path,$source ="<a href=\"http://microfan.sinaapp.com\">微饭</a>"  ) 
    { 
      $param = array(); 
      $param['pic'] = "@".$pic_path;
...
class wy_WeiboOAuth { 
    ...
    /** 
     * construct wy_WeiboOAuth object 
     */ 
