<html>
	...
	<body>
      ...
      <ul>
				...
				<?php if($_SESSION['login']) {?> <li><a href="index.php?page=setting">管理</a></li><li><a href="action.php?act=logout">退出</a></li> <?php } else { ?><li><a href="index.php?page=login">登录</a></li><?php } ?>
			 <!-- <li><form action="action.php?act=search" method="GET"><input type="text" name="key"></form></li>-->
		  </ul>
